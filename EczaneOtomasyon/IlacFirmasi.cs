...
namespace EczaneOtomasyon
{
    public partial class IlacFirmasi : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int firmaID = Convert.ToInt32(IlacFirmasiIDCombo.SelectedValue);
            int ilacid=Convert.ToInt32(IlacFirmasiIlacIDCombo.SelectedValue);
            ...
            if (rowCount == 0)
            {
               ...
               string sorgu1 = "INSERT INTO IlacFirmasiStok(IlacFirmasiIlacFirmasiID, IlacFirmasiIlacID, IlacFirmasiMiktar) VALUES (@ilacFirmasiID, @ilacID, @miktar)";
                ...
                komut.Parameters.AddWithValue("@ilacID", IlacFirmasiIlacIDCombo.SelectedValue);
            ...
            else
            {
                ...
                komut.Parameters.AddWithValue("@miktar", IlacFirmasiStokIlacAdetText.Text);
                komut.Parameters.AddWithValue("@ilacFirmasiID", IlacFirmasiIDCombo.SelectedValue);
                komut.Parameters.AddWithValue("@ilacID", IlacFirmasiIlacIDCombo.SelectedValue);
            }
            komut.ExecuteNonQuery();
            baglanti.Close();
        ...
        private void IlacFirmasiIDText_TextChanged(object sender, EventArgs e)
        {
