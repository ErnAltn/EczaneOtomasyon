...
namespace EczaneOtomasyon
{
    public partial class Doktor : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@IlacID", DoktorIlacID.SelectedValue);
        ...
        {
            string sorgu = "UPDATE Doktor SET Ad=@ad,Soyad=@soyad,TCKimlik=@tc,Brans=@brans,TecrubeYili=@tecrubeyili where DoktorID=@id";
            komut = new SqlCommand(sorgu, baglanti);
            komut.Parameters.AddWithValue("@id", DoktorIDText.Text);
            komut.Parameters.AddWithValue("@ad", DoktorAdText.Text);
            komut.Parameters.AddWithValue("@soyad", DoktorSoyadText.Text);
            komut.Parameters.AddWithValue("@tc", DoktorTcmasked.Text);
            komut.Parameters.AddWithValue("@brans", DoktorBransText.Text);
