...
namespace EczaneOtomasyon
{
    public partial class Eczane : Form
    {
        ...
        void EczaneGetir()
        {
            baglanti = new SqlConnection("Data Source=DESKTOP-83CAD35\\SQLEXPRESS;Initial Catalog=Eczane;Integrated Security=True");
            baglanti.Open();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand("Select * From EczaneStok where EczabeStokEczaneID like '%" + EczaneStokDurumText.SelectedValue + "%'", baglanti);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            int satisEczaneID = Convert.ToInt32(EczaneIlacSatiscombo.SelectedValue);
        ...
        {
            int ilacTedarikMiktar = Convert.ToInt32(IlacAdetText.Text);
            int ilacTedarikIlacFirmasiID = Convert.ToInt32(TedarikIlacFİrmasıIDText.SelectedValue);
            int ilacTedarikIlacID = Convert.ToInt32(IlaçTedarikIlacIDText.SelectedValue);
            int ilacTedarikEczaneID = Convert.ToInt32(comboBox2.SelectedValue);
        ...
        {
            baglanti.Open();
            string sorgu = "INSERT INTO EczaneTelefon(EczaneTelefonEczaneID,EczaneTelefonNO) values (@eczaneID,@telefonNo)";
            SqlCommand komut =new SqlCommand(sorgu,baglanti);
            komut.Parameters.AddWithValue("@eczaneID", EczaneIDText.Text);
        ...
        void EczaneTelefonGetir()
        {
            baglanti = new SqlConnection("Data Source=DESKTOP-83CAD35\\SQLEXPRESS;Initial Catalog=Eczane;Integrated Security=True");
            baglanti.Open();
            dat = new SqlDataAdapter("SELECT *FROM EczaneTelefon", baglanti);
            DataTable tablo = new DataTable();
            dat.Fill(tablo);
        ...
        private void TümEczaneleriGetirButton_Click(object sender, EventArgs e)
        {
            EczaneStokGetir();
        }
        ...
        {
            string sorgu = "Update Eczane Set EczaneAdi=@ad,EczaneAdresi=@adres where EczaneID=@id";
            komut = new SqlCommand(sorgu, baglanti);
            komut.Parameters.AddWithValue("@id", EczaneIDText.Text);
            komut.Parameters.AddWithValue("@ad", EczaneAdText.Text);
            komut.Parameters.AddWithValue("@adres", EczaneAdresText.Text);
            baglanti.Open();
            komut.ExecuteNonQuery();
            baglanti.Close();
            EczaneGetir();
            MessageBox.Show(EczaneAdText.Text+" Güncellendi!");
        }
    }
}
